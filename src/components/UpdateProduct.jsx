...
const UpdateProduct = () => {
    ...
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `https://ecom-backend-ursf.onrender.com/api/product/${id}`
        );

        setProduct(response.data);
      
        const responseImage = await axios.get(
          `https://ecom-backend-ursf.onrender.com/api/product/${id}/image`,
          { responseType: "blob" }
        );
  ...
  console.log("formData : ", updatedProduct)
    axios
      .put(`https://ecom-backend-ursf.onrender.com/api/product/${id}`, updatedProduct, {
        headers: {
